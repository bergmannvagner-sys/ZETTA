...
class AuditAction(str, enum.Enum):
    ...
    EMOTION_LOG_UPDATED = "EMOTION_LOG_UPDATED"
    EMOTION_LOG_DELETED = "EMOTION_LOG_DELETED"
    ...
    BILLING_WEBHOOK_PROCESSED = "BILLING_WEBHOOK_PROCESSED"
    TELECARE_SESSION_REQUESTED = "TELECARE_SESSION_REQUESTED"
    TELECARE_SESSION_STATUS_UPDATED = "TELECARE_SESSION_STATUS_UPDATED"
